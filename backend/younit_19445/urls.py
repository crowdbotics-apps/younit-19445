"""younit_19445 URL Configuration
...
admin.site.site_header = "Younit"
admin.site.site_title = "Younit Admin Portal"
admin.site.index_title = "Younit Admin"

# swagger
api_info = openapi.Info(
    title="Younit API",
    default_version="v1",
    description="API documentation for Younit App",
)
